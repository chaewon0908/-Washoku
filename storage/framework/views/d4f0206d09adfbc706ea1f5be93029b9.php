    ...
    <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary-dark"><?php echo e($stats['total_orders']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary-dark">₱<?php echo e(number_format($stats['total_revenue'], 2)); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary-dark"><?php echo e($stats['total_menu_items']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary-dark"><?php echo e($stats['total_categories']); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.orders')); ?>" class="bg-gradient-to-br from-red-600 to-red-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <a href="<?php echo e(route('admin.menu-items.index')); ?>" class="bg-gradient-to-br from-purple-600 to-purple-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center gap-4">
                        <div class="bg-white/20 rounded-full p-4">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('menu.index')); ?>" class="bg-gradient-to-br from-orange-600 to-orange-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center gap-4">
                        <div class="bg-white/20 rounded-full p-4">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center gap-4">
                        <div class="bg-white/20 rounded-full p-4">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('admin.orders')); ?>" class="text-red-600 hover:text-red-700 font-semibold">
                    View All →
                </a>
            </div>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-4"><?php echo e($order->user->name ?? 'Guest'); ?></td>
                            <td class="py-4 px-4 text-gray-600"><?php echo e($order->created_at->format('M d, Y H:i')); ?></td>
                            <td class="py-4 px-4 font-semibold">₱<?php echo e(number_format($order->total, 2)); ?></td>
                            <td class="py-4 px-4">
