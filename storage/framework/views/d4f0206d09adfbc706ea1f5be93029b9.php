    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-gray-100 mb-8 sm:mb-10 reveal">
            ...
            <div class="p-4 sm:p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 stagger-children">
                    <a href="<?php echo e(route('admin.orders')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-4 sm:p-5 rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
                    ...
                    <a href="<?php echo e(route('admin.orders.completed')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-4 sm:p-5 rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
                    ...
                    <a href="<?php echo e(route('admin.orders.cancelled')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-4 sm:p-5 rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
                        <div class="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-red-500/50 to-transparent"></div>
                        <div class="relative z-10 flex items-center gap-3 sm:gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 bg-red-600/20 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:bg-red-600 transition-colors flex-shrink-0">
                    ...
                    <a href="<?php echo e(route('admin.menu-items.index')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-4 sm:p-5 rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
                    ...
                    <a href="<?php echo e(route('menu.index')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-4 sm:p-5 rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-gray-100 reveal">
            <div class="bg-gradient-to-r from-gray-50 to-white px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <a href="<?php echo e(route('admin.orders.all')); ?>" class="text-red-600 hover:text-red-700 font-semibold text-xs sm:text-sm flex items-center gap-1">
                    View All
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-white/50 transition-all duration-200 reveal-scale" style="transition-delay: <?php echo e($loop->index * 50); ?>ms;">
                            <td class="py-3 sm:py-4 px-3 sm:px-6">
                                <a href="<?php echo e(route('admin.orders')); ?>?order=<?php echo e($order->order_number); ?>" class="text-red-600 hover:text-red-700 font-semibold text-xs sm:text-sm">
                                    <?php echo e($order->order_number); ?>

                                </a>
                            </td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6 text-gray-700 text-xs sm:text-sm"><?php echo e($order->user->name ?? 'Guest'); ?></td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6 text-gray-500 text-xs sm:text-sm hidden md:table-cell"><?php echo e($order->created_at->format('M d, Y H:i')); ?></td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6 font-bold text-gray-800 text-xs sm:text-sm">₱<?php echo e(number_format($order->total, 2)); ?></td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6">
