    ...
    <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-red-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 group-hover:text-white transition-colors"><?php echo e($stats['total_orders']); ?></p>
                    </div>
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-amber-600 group-hover:text-amber-400 transition-colors"><?php echo e($stats['pending_orders']); ?></p>
                    </div>
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-green-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 group-hover:text-green-400 transition-colors"><?php echo e($stats['completed_orders']); ?></p>
                    </div>
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-red-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 group-hover:text-amber-400 transition-colors">₱<?php echo e(number_format($stats['total_revenue'], 2)); ?></p>
                    </div>
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-purple-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 group-hover:text-white transition-colors"><?php echo e($stats['total_menu_items']); ?></p>
                    </div>
            ...
            <div class="group bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-indigo-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 group-hover:text-white transition-colors"><?php echo e($stats['total_categories']); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 mb-10">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="group relative bg-gradient-to-br from-[#1a1a1a] to-[#2d1f1f] text-white p-5 rounded-xl shadow-lg hover:shadow-2xl transition-all hover:scale-[1.02] overflow-hidden">
                        <div class="absolute inset-0 opacity-[0.05] seigaiha-pattern"></div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.orders')); ?>" class="text-red-600 hover:text-red-700 font-semibold text-sm flex items-center gap-1">
                    View All
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    ...
                                    <?php elseif($order->status === 'preparing'): ?> bg-purple-100 text-purple-700
                                    <?php elseif($order->status === 'delivering'): ?> bg-indigo-100 text-indigo-700
