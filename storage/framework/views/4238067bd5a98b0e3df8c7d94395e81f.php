    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <?php if($categorySlug): ?>
                <a href="<?php echo e(route('menu.category', $categorySlug)); ?>" 
                   class="group relative block h-full">
                    ...
                    <div class="relative h-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 overflow-hidden transform hover:-translate-y-3 border border-white/50 hover:border-opacity-100">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-br <?php echo e($categoryData['gradient']); ?> opacity-0 group-hover:opacity-10 transition-opacity duration-700"></div>
                        ...
                        <div class="relative p-8 h-full flex flex-col z-10">
                            ...
                            <div class="mb-8 flex justify-center">
                                <div class="relative">
                                    <!-- Outer Glow -->
                                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($categoryData['gradient']); ?> rounded-full blur-2xl opacity-0 group-hover:opacity-40 transition-opacity duration-700 transform group-hover:scale-150"></div>
                                    
                                    <!-- Middle Glow -->
                                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($categoryData['gradient']); ?> rounded-full blur-lg opacity-0 group-hover:opacity-30 transition-opacity duration-700 transform group-hover:scale-125"></div>
                                    
                                    <!-- Icon Container -->
                                    <div class="relative w-28 h-28 <?php echo e($categoryData['bg']); ?> rounded-full flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-700 shadow-2xl group-hover:shadow-3xl border-4 border-white/50 group-hover:border-white">
                                        <!-- Inner Glow -->
                                        <div class="absolute inset-2 bg-gradient-to-br <?php echo e($categoryData['gradient']); ?> rounded-full opacity-0 group-hover:opacity-20 blur-md transition-opacity duration-700"></div>
                                        <span class="relative text-6xl transform group-hover:scale-110 group-hover:rotate-[-12deg] transition-all duration-700 filter drop-shadow-lg"><?php echo e($categoryData['icon']); ?></span>
                                    </div>
                                </div>
                            </div>
                            
                            <!-- Title with Gradient -->
                            <h2 class="text-2xl font-extrabold text-center mb-4 <?php echo e($categoryData['textColor']); ?> group-hover:bg-gradient-to-r <?php echo e($categoryData['gradient']); ?> group-hover:bg-clip-text group-hover:text-transparent transition-all duration-500 tracking-tight">
                            ...
                            <!-- Enhanced CTA Button -->
                            <div class="mt-auto">
                                <div class="relative inline-flex items-center justify-center w-full px-6 py-4 bg-gradient-to-r <?php echo e($categoryData['gradient']); ?> text-white font-bold rounded-2xl shadow-lg group-hover:shadow-2xl transform group-hover:scale-105 transition-all duration-500 overflow-hidden">
                                    <!-- Button Shimmer -->
                        ...
                        <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br <?php echo e($categoryData['gradient']); ?> opacity-0 group-hover:opacity-15 rounded-bl-full transition-opacity duration-700"></div>
                        <div class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr <?php echo e($categoryData['gradient']); ?> opacity-0 group-hover:opacity-10 rounded-tr-full transition-opacity duration-700"></div>
                        
                        <!-- Border Glow Effect -->
                        <div class="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-gradient-to-br <?php echo e($categoryData['gradient']); ?> opacity-0 group-hover:opacity-30 transition-opacity duration-700 pointer-events-none"></div>
                    </div>
                </a>
                <?php endif; ?>
