    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 md:gap-0">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 md:gap-4 mt-4 md:mt-0">
                <a href="<?php echo e(route('admin.orders.completed')); ?>" class="flex items-center gap-1.5 sm:gap-2 text-white/70 hover:text-green-400 transition-colors text-sm sm:text-base">
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-gray-100 reveal" x-data="{ searchQuery: '<?php echo e(request('search')); ?>' }">
            ...
            <div class="p-4 sm:p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                <form method="GET" action="<?php echo e(route('admin.orders')); ?>" class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.orders')); ?>" class="px-4 sm:px-6 py-2.5 sm:py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl transition-all flex items-center gap-1.5 sm:gap-2">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-white/50 transition-all duration-200 reveal-scale" style="transition-delay: <?php echo e($loop->index * 30); ?>ms;">
                            ...
                            <td class="py-3 sm:py-4 px-3 sm:px-6 hidden lg:table-cell">
                                <p class="text-xs sm:text-sm text-gray-600"><?php echo e($order->created_at->format('M d, Y')); ?></p>
                                <p class="text-[10px] sm:text-xs text-gray-400"><?php echo e($order->created_at->format('H:i')); ?></p>
                            </td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6">
                                <span class="text-sm sm:text-lg font-bold text-red-600">₱<?php echo e(number_format($order->total, 2)); ?></span>
                            </td>
                            <td class="py-3 sm:py-4 px-3 sm:px-6">
            ...
            <div class="text-center py-10 sm:py-12 md:py-16">
                ...
                <p class="text-gray-400 text-xs sm:text-sm mt-2 px-4">Completed orders can be found in the 
                    <a href="<?php echo e(route('admin.orders.completed')); ?>" class="text-green-600 hover:text-green-700 font-medium">Completed Orders</a> dashboard.
                    Cancelled orders can be found in the 
                    <a href="<?php echo e(route('admin.orders.cancelled')); ?>" class="text-red-600 hover:text-red-700 font-medium">Cancelled Orders</a> dashboard.
                </p>
            </div>
            <?php endif; ?>
        </div>
