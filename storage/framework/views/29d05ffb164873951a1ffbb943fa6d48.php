...
<div class="min-h-screen bg-gradient-to-br from-warm-cream to-warm-beige py-12">
    <div class="container mx-auto px-4">
        <div class="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <h1 class="text-4xl font-serif font-bold text-primary-dark mb-6">Welcome, <?php echo e(Auth::user()->name); ?>!</h1>
            
            <?php if(Auth::user()->isAdmin() || Auth::user()->isOrderProcessor()): ?>
            <div class="mb-6">
                <a href="<?php echo e(route('admin.index')); ?>" class="inline-block bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold">
                    Admin Panel
                </a>
            </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <a href="<?php echo e(route('dashboard.orders')); ?>" class="bg-gradient-to-br from-red-600 to-red-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <a href="<?php echo e(route('cart')); ?>" class="bg-gradient-to-br from-orange-600 to-orange-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                    <div class="flex items-center gap-4">
                        <div class="bg-white/20 rounded-full p-4">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-lg text-primary-dark"><?php echo e($order->order_number); ?></h3>
                            <p class="text-sm text-gray-600"><?php echo e($order->created_at->format('M d, Y H:i')); ?></p>
                            <p class="text-sm text-gray-600">Total: ₱<?php echo e(number_format($order->total, 2)); ?></p>
                        </div>
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('dashboard.orders')); ?>" class="text-red-600 hover:text-red-700 font-semibold">
                    View All Orders →
                </a>
            </div>
            <?php else: ?>
            <div class="text-center py-12">
                ...
                <a href="<?php echo e(route('bento.builder')); ?>" class="inline-block bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold">
                    Start Shopping
                </a>
            </div>
            <?php endif; ?>
