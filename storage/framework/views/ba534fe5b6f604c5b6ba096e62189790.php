               ...
               class="group relative block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-transparent hover:border-red-200">
                ...
                <div class="aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-50 relative">
                    <img src="<?php echo e($category['image']); ?>" 
                         ...
                         class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                         loading="lazy"
                         onerror="this.onerror=null; this.src='https://via.placeholder.com/600x600/f3f4f6/9ca3af?text=<?php echo e(urlencode($category['name'])); ?>';">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <?php $__currentLoopData = $bestsellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e($item['link']); ?>" class="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-transparent hover:border-red-200 block cursor-pointer">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-3xl font-bold text-red-600">₱<?php echo e(number_format($item['price'], 0)); ?></span>
                            </div>
