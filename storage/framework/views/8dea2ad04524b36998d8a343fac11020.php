    ...
    <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="flex items-center gap-3">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="flex items-center gap-3 md:gap-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 text-sm md:text-base font-semibold text-white hover:text-yellow-200 transition-colors group">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-sm md:text-base font-medium text-white/90 hover:text-yellow-200 transition-colors px-2 py-1 rounded-md hover:bg-white/10">
                            Profile
                        </a>
                ...
                <?php else: ?>
                    ...
                    <div class="flex items-center gap-2 md:gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-semibold text-white/90 hover:text-white transition-colors px-3 py-1.5 rounded-lg hover:bg-white/10">
                            <svg class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                            </svg>
                            <span class="hidden sm:inline">Log In</span>
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-white/25 to-white/15 hover:from-white/35 hover:to-white/25 backdrop-blur-md px-4 md:px-5 py-2 md:py-2.5 rounded-full text-xs md:text-sm font-semibold transition-all duration-300 border border-white/20 hover:border-white/30 hover:shadow-lg">
        ...
        <nav class="border-t border-white/10 bg-gradient-to-b from-transparent to-white/5">
            <ul class="flex gap-6 lg:gap-8 py-4 items-center overflow-x-auto scrollbar-hide">
                ...
                <li>
                    <a href="<?php echo e(route('stores')); ?>" class="relative py-2.5 px-3 rounded-lg hover:bg-white/10 transition-all duration-300 font-semibold group">
                ...
                <?php if(auth()->guard()->check()): ?>
                <li>
                    <a href="<?php echo e(route('dashboard.orders')); ?>" class="relative py-2.5 px-3 rounded-lg hover:bg-white/10 transition-all duration-300 font-semibold group flex items-center gap-2">
                ...
                <?php if(Auth::check() && (Auth::user()->isAdmin() || Auth::user()->isOrderProcessor())): ?>
                <li>
                    <a href="<?php echo e(route('admin.index')); ?>" class="inline-flex items-center py-2.5 px-4 rounded-full bg-yellow-400/30 font-bold text-yellow-50 group hover:bg-yellow-400/40 transition-all duration-300 shadow-md hover:shadow-lg">
                        Admin Panel
                    </a>
                </li>
                <?php endif; ?>
