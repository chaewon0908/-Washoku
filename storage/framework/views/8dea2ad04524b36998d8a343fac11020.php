    ...
    <div class="container mx-auto px-3 sm:px-4 relative z-10">
            ...
            <div class="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base font-medium text-white/90 hover:text-amber-300 transition-colors group">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-xs sm:text-sm font-medium text-white/70 hover:text-amber-300 transition-colors hidden md:inline">
                            Profile
                        </a>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" class="inline hidden md:inline" id="logout-form">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <!-- Logged Out State -->
                    <div class="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="flex items-center gap-1 sm:gap-1.5 md:gap-2 text-xs sm:text-sm font-medium text-white/80 hover:text-white transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full hover:bg-white/5 border border-transparent hover:border-white/10">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="relative overflow-hidden bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-md px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 border border-white/20 hover:border-amber-400/40 group">
        ...
        <nav class="border-t border-white/10">
            <ul class="flex gap-1 sm:gap-1.5 lg:gap-2 py-2 sm:py-2.5 md:py-3 items-center overflow-x-auto scrollbar-hide">
                ...
                <?php if(auth()->guard()->check()): ?>
                <li>
                    <a href="<?php echo e(route('dashboard.orders')); ?>" class="nav-link flex items-center gap-1 sm:gap-1.5 md:gap-2 <?php echo e(request()->routeIs('dashboard.orders') ? 'nav-link-active' : ''); ?>">
                ...
                <?php if(Auth::check() && (Auth::user()->isAdmin() || Auth::user()->isOrderProcessor())): ?>
                <li class="ml-auto">
                    <a href="<?php echo e(route('admin.index')); ?>" class="inline-flex items-center gap-1.5 sm:gap-2 py-1.5 sm:py-2 md:py-2.5 px-3 sm:px-4 md:px-5 rounded-full text-xs sm:text-sm md:text-base font-bold text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 transition-all duration-300 shadow-lg hover:scale-105 whitespace-nowrap">
                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
