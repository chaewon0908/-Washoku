        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-3 font-serif">
                    Edit <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-300">Menu Item</span>
                </h1>
                <p class="text-white/60 text-lg">Update menu item details</p>
            </div>
...
<section class="bg-gradient-to-br from-[#f8f5f0] via-[#f5f1e8] to-[#ebe5d9] py-12 relative overflow-hidden min-h-screen">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 max-w-4xl mx-auto">
            ...
            <form method="POST" action="<?php echo e(route('admin.menu-items.update', $menuItem)); ?>" enctype="multipart/form-data" class="p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div class="w-32 h-32 rounded-xl overflow-hidden border-2 border-gray-200 shadow-md">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all resize-none"><?php echo e(old('description', $menuItem->description)); ?></textarea>
                    </div>
