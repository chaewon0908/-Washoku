...
<?php $__env->startSection('title', 'Cancelled Orders - Admin Panel'); ?>
...
<section class="relative bg-gradient-to-br from-[#1a1a1a] via-[#2d1f1f] to-[#1a1a1a] py-12 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex justify-between items-center">
            <div>
                <p class="text-red-400/80 text-sm font-medium tracking-widest uppercase mb-3 reveal-scale">Order History</p>
                ...
                <p class="text-white/60 text-lg reveal" style="transition-delay: 200ms;">View all cancelled orders</p>
            </div>
...
<section class="bg-gradient-to-br from-[#f8f5f0] via-[#f5f1e8] to-[#ebe5d9] py-12 relative overflow-hidden min-h-screen">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 reveal" x-data="{ searchQuery: '<?php echo e(request('search')); ?>' }">
            ...
            <!-- Search Bar -->
            <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-red-50/50 to-white">
                <form method="GET" action="<?php echo e(route('admin.orders.cancelled')); ?>" class="flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.orders.cancelled')); ?>" class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-all flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-red-50/50 to-white border-b border-gray-100">
                            ...
                            <th class="text-left py-4 px-6 font-semibold font-english text-gray-700 text-sm uppercase tracking-wider">Date Cancelled</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-red-50/30 hover:to-white/50 transition-all duration-200 reveal-scale" style="transition-delay: <?php echo e($loop->index * 30); ?>ms;">
                            <td class="py-4 px-6">
                            ...
                            <td class="py-4 px-6">
                                <span class="text-lg font-bold text-red-600">₱<?php echo e(number_format($order->total, 2)); ?></span>
                            </td>
                            <td class="py-4 px-6">
                                <span class="px-3 py-1.5 rounded-full text-xs font-semibold bg-red-100 text-red-700 flex items-center gap-1 w-fit">
            ...
            <div class="px-6 py-4 bg-red-50/30 border-t border-gray-100">
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 text-lg">No cancelled orders yet</p>
                <p class="text-gray-400 text-sm mt-2">Orders will appear here once they are marked as cancelled</p>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Josh Almoite\Documents\Laravel\japanese-restaurant\resources\views/admin/cancelled-orders.blade.php ENDPATH**/ ?>