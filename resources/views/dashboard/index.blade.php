...
<div class="min-h-screen bg-gradient-to-br from-[#f8f5f0] via-[#f5f1e8] to-[#ebe5d9] py-12 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#2d1f1f] to-[#1a1a1a] rounded-3xl shadow-2xl p-8 md:p-10 mb-8 overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <a href="{{ route('admin.index') }}" class="inline-flex items-center gap-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white px-6 py-4 rounded-2xl font-bold transition-all duration-300 shadow-lg hover:shadow-red-900/40 hover:scale-105 group border border-red-500/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <!-- My Orders Card -->
            <a href="{{ route('dashboard.orders') }}" class="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <!-- Card Background -->
            ...
            <!-- Shopping Cart Card -->
            <a href="{{ route('cart') }}" class="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <!-- Card Background -->
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white px-8 py-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    @if($orders->count() > 0)
                    <a href="{{ route('dashboard.orders') }}" class="hidden sm:flex items-center gap-2 text-red-600 hover:text-red-700 font-semibold transition-colors group">
                        <span>View All</span>
                        <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                        </svg>
            ...
            <div class="p-8">
                    ...
                    <div class="group relative bg-gradient-to-r from-gray-50 to-white border border-gray-100 rounded-2xl p-5 hover:shadow-lg hover:border-red-100 transition-all duration-300">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-lg text-gray-800 group-hover:text-red-600 transition-colors">{{ $order->order_number }}</h3>
                                    <div class="flex items-center gap-3 text-sm text-gray-500">
                                        <span>{{ $order->created_at->format('M d, Y H:i') }}</span>
                                        <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
                                        <span class="font-semibold text-gray-700">₱{{ number_format($order->total, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3">
                                <span class="px-4 py-2 rounded-full text-sm font-bold
                                    ...
                                    @elseif($order->status === 'preparing') bg-purple-100 text-purple-700 border border-purple-200
                                    @elseif($order->status === 'delivering') bg-indigo-100 text-indigo-700 border border-indigo-200
                ...
                <div class="mt-6 text-center sm:hidden">
                    <a href="{{ route('dashboard.orders') }}" class="inline-flex items-center gap-2 text-red-600 hover:text-red-700 font-semibold">
                ...
                <div class="text-center py-16">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="{{ route('bento.builder') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white px-8 py-4 rounded-full font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
