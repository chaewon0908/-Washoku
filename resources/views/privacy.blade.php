...
<section class="relative bg-gradient-to-br from-[#1a1a1a] via-[#2d1f1f] to-[#1a1a1a] py-16 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center">
            <p class="text-amber-400/80 text-sm font-medium tracking-widest uppercase mb-4">Your Privacy</p>
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-4 font-serif">
                Privacy <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-300">Policy</span>
            </h1>
            <p class="text-white/60 text-lg max-w-2xl mx-auto">How we protect your information.</p>
        </div>
    </div>
</section>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
            ...
            <div class="space-y-8">
                <div>
                    ...
                    <div class="pl-11">
                        <p class="text-gray-600 mb-3">We collect information you provide directly to us, including:</p>
                        <ul class="space-y-2">
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed pl-11">We do not sell your personal information. We may share your information with third-party service providers who assist us in operating our business, such as payment processors and delivery partners.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed pl-11">We implement appropriate security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed pl-11">We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. You can control cookie preferences through your browser settings.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed pl-11">Our services are not directed to children under 13. We do not knowingly collect personal information from children under 13.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed pl-11">We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page.</p>
                </div>
                
                <div>
                    <h2 class="text-xl font-bold text-gray-800 mb-3 flex items-center gap-3">
                        <span class="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center text-red-600 font-bold text-sm">9</span>
                        Contact Us
                    </h2>
                    <div class="pl-11">
                        <p class="text-gray-600 mb-2">If you have any questions about this Privacy Policy, please contact us at:</p>
