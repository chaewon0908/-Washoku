...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f8f5f0] via-[#f5f1e8] to-[#ebe5d9] py-16 px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10" x-data="{ showPassword: false, showConfirmPassword: false }">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required 
                                autofocus
                                class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all duration-300 outline-none @error('name') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                value="{{ old('email') }}"
                                required
                                class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all duration-300 outline-none @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                name="password" 
                                required
                                class="w-full pl-12 pr-12 py-3 rounded-xl border-2 border-gray-200 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-all duration-300 outline-none @error('password') border-red-500 @enderror"
                                placeholder="••••••••">
        ...
        <div class="text-center mt-6">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors group">
