...
<section class="relative bg-gradient-to-br from-[#1a1a1a] via-[#2d1f1f] to-[#1a1a1a] py-12 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.menu-items.index') }}" class="hidden md:flex items-center gap-2 text-white/70 hover:text-amber-400 transition-colors">
...
<section class="bg-gradient-to-br from-[#f8f5f0] via-[#f5f1e8] to-[#ebe5d9] py-12 relative overflow-hidden min-h-screen">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 max-w-4xl mx-auto">
            ...
            <form method="POST" action="{{ route('admin.menu-items.update', $menuItem) }}" enctype="multipart/form-data" class="p-8">
                @csrf
                @method('PUT')

                <!-- Current Image Preview -->
                @if($menuItem->image || $menuItem->image_url)
                <div class="mb-6 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div class="w-32 h-32 rounded-xl overflow-hidden border-2 border-gray-200 shadow-md">
                        ...
                        @elseif($menuItem->image_url)
                            <img src="{{ $menuItem->image_url }}" alt="{{ $menuItem->name }}" class="w-full h-full object-cover">
                        @endif
                    </div>
                </div>
                @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all resize-none">{{ old('description', $menuItem->description) }}</textarea>
                    </div>

                    <!-- Price -->
                    <div>
                        <label for="price" class="block text-sm font-semibold text-gray-700 mb-2">Price (₱) *</label>
                        <input type="number" id="price" name="price" value="{{ old('price', $menuItem->price) }}" step="0.01" min="0" required
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="calories" name="calories" value="{{ old('calories', $menuItem->calories) }}" min="0" max="5000"
                            placeholder="e.g. 520"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" id="image_url" name="image_url" value="{{ old('image_url', $menuItem->image_url) }}"
                    ...
                    <div class="md:col-span-2 bg-gray-50 rounded-xl p-5">
                        ...
                        <div class="flex flex-wrap gap-6">
                            ...
                            <label class="flex items-center cursor-pointer group">
                                <input type="checkbox" name="is_bestseller" value="1" {{ old('is_bestseller', $menuItem->is_bestseller) ? 'checked' : '' }}
                                    class="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500">
                ...
                <div class="mt-8 flex gap-4">
                    ...
                    <a href="{{ route('admin.menu-items.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-semibold transition-colors">
                        Cancel
                    </a>
                </div>
            </form>
